...
namespace Ebooking.Migrations
{
    ...
    [Migration("20241022095712_modified-checkout")]
    partial class modifiedcheckout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.CheckoutSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("api.Models.CouponCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("api.Models.PaymentInformation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ebooking.Models.Bookings", b =>
                {
                    ...
                    b.HasOne("api.Models.CheckoutSession", "CheckoutSession")
                        .WithMany()
                        .HasForeignKey("CheckoutSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ebooking.Models.Events", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("api.Models.CheckoutSession", b =>
                {
                    ...
                    b.OwnsMany("api.Models.Tickets", "Tickets", b1 =>
                        {
                            ...
                            b1.HasKey("CheckoutSessionId", "Id");
            ...
            modelBuilder.Entity("api.Models.PaymentInformation", b =>
                {
                    b.HasOne("api.Models.CheckoutSession", "CheckoutSession")
                        ...
                        .HasForeignKey("api.Models.PaymentInformation", "CheckoutSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
