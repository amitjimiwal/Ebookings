...
namespace Ebooking.Migrations
{
    ...
    [Migration("20241021101726_booking-payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ebooking.Models.Bookings", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.List<Ebooking.Models.TicketInformation>", "TicketInformation", b1 =>
                        {
            ...
            modelBuilder.Entity("api.Models.PaymentInformation", b =>
                {
                    b.HasOne("Ebooking.Models.Bookings", "Booking")
                        .WithOne("PaymentInformation")
                        .HasForeignKey("api.Models.PaymentInformation", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
